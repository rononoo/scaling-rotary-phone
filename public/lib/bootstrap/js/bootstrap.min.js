...
!(function (t, e) {
  ...
  var o = (function (t) {
    ...
    h = (function (t) {
        ...
        I = (function () {
          ...
          return (
              ...
              this._config.keyboard &&
                ...
                'hover' === this._config.pause &&
                  ...
                  'ontouchstart' in document.documentElement &&
                    t(this._element).on(_.TOUCHEND, function () {
                      e.pause(),
            ...
            (I._getItemIndex = function (e) {
              return (
                (this._items = t.makeArray(t(e).parent().find(C.ITEM))),
            ...
            (I._slide = function (e, n) {
              ...
              if (
                ...
                if (
                  ...
                  o.supportsTransitionEnd() && t(this._element).hasClass(p)
                    ? (t(u).addClass(s),
                      o.reflow(u),
                      t(l).addClass(i),
                      t(u).addClass(i),
      ...
      return (
        t(document).on(_.CLICK_DATA_API, C.DATA_SLIDE, I._dataApiClickHandler),
              ...
              if (!this._isTransitioning && !t(this._element).hasClass(u)) {
                ...
                if (
                  ...
                  if ((t(this._element).trigger(a), !a.isDefaultPrevented())) {
                    s &&
                      (i._jQueryInterface.call(t(s), 'hide'),
                      r || t(s).data(n, null));
                ...
                if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                  ...
                  if (
                    ...
                    for (var s = 0; s < this._triggerArray.length; s++) {
                      ...
                      if (null !== a) {
                        t(a).hasClass(u) ||
                          t(r).addClass(_).attr('aria-expanded', !1);
                      }
                    }
                  this.setTransitioning(!0);
                  var l = function () {
    ...
    u = (function (t) {
        ...
        L = (function () {
          ...
          return (
            ...
            (h._getPlacement = function () {
              ...
              return (
                e.hasClass(_)
                  ? ((n = b), t(this._menu).hasClass(p) && (n = D))
                  : e.hasClass(g)
                  ? (n = N)
                  : e.hasClass(m)
                  ? (n = O)
      ...
      return (
        t(document)
          ...
          .on(u.CLICK_DATA_API + ' ' + u.KEYUP_DATA_API, L._clearMenus)
          ...
          return (
            ...
            (p._resetScrollbar = function () {
              t(m.FIXED_CONTENT).each(function (e, n) {
                ...
                t(m.STICKY_CONTENT + ', ' + m.NAVBAR_TOGGLER).each(
                  function (e, n) {
            ...
            (a._jQueryInterface = function (e, i) {
              return this.each(function () {
                ...
                if (
                  (s || ((s = new a(this, o)), t(this).data(n, s)),
                  'string' == typeof e)
                ) {
          ...
          return (
            ...
            (A.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                o.supportsTransitionEnd() && t(this.tip).hasClass(m)
                  ? t(this.tip)
            ...
            (A.hide = function (e) {
              ...
              t(this.element).trigger(s),
                s.isDefaultPrevented() ||
                  ...
                  o.supportsTransitionEnd() && t(this.tip).hasClass(m)
                    ? t(i).one(o.TRANSITION_END, r).emulateTransitionEnd(150)
                    : r(),
                  (this._hoverState = ''));
            }),
            (A.update = function () {
            ...
            (A._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                t(n.getTipElement()).hasClass(p) || n._hoverState === d
                  ? (n._hoverState = d)
            ...
            (l._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (n || ((n = new l(this, s)), t(this).data(i, n)),
                  'string' == typeof e)
                ) {
                  if ('undefined' == typeof n[e])
                    throw new Error('No method named "' + e + '"');
        ...
        m = (function () {
          ...
          return (
            ...
            (m._activate = function (e) {
              ...
              var i = t(n.join(','));
              i.hasClass(u)
                ? (i.closest(d.DROPDOWN).find(d.DROPDOWN_TOGGLE).addClass(f),
                  i.addClass(f))
                : (i.addClass(f),
                  i
        ...
        E = (function () {
          ...
          return (
            ...
            (i._activate = function (e, n, i) {
              ...
              r && a
                ? t(r).one(o.TRANSITION_END, l).emulateTransitionEnd(150)
                : l();
            }),
